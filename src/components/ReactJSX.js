...
const ReactJSX = () => {
  return (
    <div>
      ...
      <p>Basically JSX is a way of writing HTML-like code inside JavaScript code.</p>
      ...
      <p>JSX is like a plain JavaScript object, it can be assigned to variables, returned from functions, passed to functions, passed to logical and ternary operators, passed <a href="https://reactjs.org/docs/context.html#before-you-use-context">as a prop</a> etc.</p>
    </div>
  );
};
