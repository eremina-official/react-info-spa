...
const ChangeDetectionInReact = () => {
  return (
    <div>
      ...
      <p className="font-italic text-weight-bold">What is change detection?</p>
      ...
      <p className="font-italic text-weight-bold">Change detection implementation in React</p>
