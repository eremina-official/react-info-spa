...
const HandlingEvents = () => {
  return (
    <div>
      ...
      <p>Event handlers are declared as properties of React Elements. There is a corresponding property for each DOM event (onClick etc).</p>
      ...
      <p><code>SyntheticEvent</code> is a cross-browser wrapper around the browser’s native event (this wrapper accounts for differences in events implementation across different browsers).</p>
    </div>
  );
};
