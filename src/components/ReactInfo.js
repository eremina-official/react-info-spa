...
const ReactInfo = () => {
  return (
    <div>
      ...
      <p>As a part of a declarative approach React abstracts HTML DOM manipulation: we declare what a component should look like and React calls the HTML DOM API methods under the hood (<a href="https://reactjs.org/docs/faq-internals.html#what-is-the-virtual-dom">link</a>).</p>
